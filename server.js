...
const app = express(); 280000;
app.get("/", (request, response) => {
  response.sendStatus(200);
});
app.listen(process.env.PORT);
setInterval(() => {
  http.get(`http://gosestemssa5.glitch.me/`); ///مهم حط بدل 333م البروجكت
}, 280000);
...
const dev = "634802791541637173"; ///تعديل مهم حط ايدي حسابك
const admin = "=";
var owner = "634802791541637173"; // Owner Bot Mention /// تعديل مهم حط ايدي حسابكتعديل مهم ايدي حسابك
...
client.on("ready", () => {
  ...
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setActivity("GoSystem"); ///تعديل مهم غير كلمة هيلب وبرميوم اللي بدك اياه مثل اسم سيرفرك
...
client.on("message", zaid => {
  if (zaid.content === "=bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@634802791541637173>`, true) // تعديل مهم عدل هذا الرقم لايدي حسابك
      .setImage("")
...
let room = "753318180084252673"; //تعديل مهم ايدي روم عد الاعضاء والترحيب ، روم صوتي
...
client.on("guildMemberAdd", member => {
  ...
  var embed = new Discord.RichEmbed()
    ...
    .setColor("RANDOM");
  var channel = member.guild.channels.find("name", "・gobot-welcome"); //تعديل مهم اسم روم الولكم
  if (!channel) return;
...
**  =meme  • لعمل ميمز **
**  =help (نفس امر الهيلب العادي) •   قولك اوامر الالعاب**
جميع الحقوق محفوظه عند ادم
...
client.on("message", message => {
  ...
  if (message.content === prefix + "3help") {
    ...
    message.author.sendMessage(`  ** جميع الحقوق محفوظه عند ادم **
** تم عمل بوت موسيقي في السيرفر **
<@749345502008442891>    
`);
  }
});
...
> ** =5help ** ** اوامر مميزه  **
 **__Done__** 
 **__جميع الحقوق محفوظه  عند ادم__**
   `);
  }
});
...
client.on("message", msg => {
  if (msg.content === "invite") {
    msg.reply("** https://discord.com/api/oauth2/authorize?client_id=748571102250401823&permissions=8&scope=bot **  ");
  }
});

client.on("message", msg => {
  if (msg.content === "لماذا نحن هنا") {
    msg.reply("** اشياء غريبه تحدث **  ");
  }
});

client.on("message", msg => {
  if (msg.content === "GoSystem") {
    msg.reply("** ماذا تريد؟ **  ");
  }
});
...
client.on("message", async message => {
  ...
  if (Fire === "addcredits") {
    ...
    message.reply(`**, Added Money For :** \`${args[1]}\`Done`);
...
client.on("message", msg => {
  if (msg.content.startsWith(prefix + "help")) { //Adam_,,❤🍭#6066
      const embed = new Discord.RichEmbed()
    .setTitle("Help") //Adam_,,❤🍭#6066 
    .setDescription("Here The Support Server Link Please Support us if There's Any Problom")
    .addField("Support Server","https://discord.gg/uasehBW")
    .setTimestamp()
...
sa7erbrahym.channel.send(use,{embed : mohmedramdan})
 ...
 client.on("message", message => { if (message.content.startsWith(prefix + "test")) { message.channel.send(" **البوت شغال تمام :white_check_mark: **"); }});

client.on("ready", () => {
let BotOnline = client.channels.get("750016421991547020");// ايدي الروم
      ...
      if (message.author.bot) return
           message.delete();
             let args = message.content.split(' ').slice(1);
                 ...
                 message.channel.send({embed: new Discord.RichEmbed().setTitle('Loading ' + virusname + "...").setColor(0x2A5264)}).then(function(m) {
             setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓ ] 1%').setColor(0x2A5264)})
             }, 1000)
             setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓ ] 2%').setColor(0x2A5264)})
             }, 2000)
               setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓ ] 3%').setColor(0x2A5264)})
             }, 3000)
             setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓ ] 4%').setColor(0x2A5264)})
             }, 4000)
               setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓ ] 20%').setColor(0x2A5264)})
             }, 5000)
               setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓ ] 30%').setColor(0x2A5264)})
             }, 6000)
               setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ ] 40%').setColor(0x2A5264)})
             }, 7000)
               setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ ] 50%').setColor(0x2A5264)})
             }, 8000)
               setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ ] 70%').setColor(0x2A5264)})
             }, 9000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ ] 85%').setColor(0x2A5264)})
             }, 10000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ ] 90%').setColor(0x2A5264)})
             }, 11000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ ] 95%').setColor(0x2A5264)})
             }, 12000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ ] 96%').setColor(0x2A5264)})
             }, 13000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ ] 97%').setColor(0x2A5264)})
             }, 14000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓] 98%').setColor(0x2A5264)})
             }, 15000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ ] 99%').setColor(0x2A5264)})
             }, 16000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Loading Discord Virus [▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓] 100%').setColor('6cb69f')})
             }, 17000)
             setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']:' + virusname + 'done it\'s going good 100.9%').setColor('6cb69f')})
             }, 18000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Hacking').setColor('6cb69f')})
             }, 19000)
               setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Update' + virusname + ".key").setColor('6cb69f')})
             }, 22000)
               setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']:Wait 5 seconds').setColor('6cb69f')})
             }, 25000)
               setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']:Wait 4 seconds ').setColor('6cb69f')})
             }, 26000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']: Wait 3 seconds').setColor(0xFF0000)})
             }, 27000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']:Wait 2 seconds').setColor('6cb69f')})
             }, 28000)
                setTimeout(function() {
               m.edit({embed: new Discord.RichEmbed().setTitle('[' + virusname + ']:Wait 1 second').setColor('6cb69f')})
             }, 29000)
             setTimeout(function() {
             ...
             setTimeout(function() {
               message.channel.send('**Hacked :pirate_flag: **')
           }, 33000)
           });
         }
})
...
let st = ["=help", "GobotSupport "];
setInterval(function() {
  let status = st[Math.floor(Math.random() * st.length)];
  client.user.setActivity(status, "WATCHING"); 
}, 5000) 
})
...
client.login('NzQ4NTcxMTAyMjUwNDAxODIz.X0fXKg.X36EI9Hj7JDnu6QQBB5tBDhibgk');
